...
import { setActiveTab, setFromDate, setLatitude, setLongitude, setToDate, setWeatherData } from "../../store/slices/appSlice";
...

  {
    return weatherData.length === 0 ? (
      ...
      <div className="h-full bg-red-300 overflow-auto px-4">
        <div className="bg-white p-3 my-2 rounded-lg h-[8%] sm:h-[10%] text-black flex gap-x-3">
          <button
